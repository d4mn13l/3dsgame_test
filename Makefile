#changes that i might want to reverse at some point:
#	- removing --fno-rtti cxxflag to use typeid (tradeoff: executable is larger)
#	- clean doesnt remove romfs (i dont want to push 70 test images to github)
...
SUBDIRS1	:=	$(wildcard */)
SUBDIRS2	:=	$(foreach subdir1, $(SUBDIRS1), $(wildcard $(subdir1)*))
SUBDIRS3	:=	$(foreach subdir2, $(SUBDIRS2), $(wildcard $(subdir2)*))
SUBDIRS4	:=	$(foreach subdir3, $(SUBDIRS3), $(wildcard $(subdir3)*))
